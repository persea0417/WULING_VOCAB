    ...
    if (filtered.length === 0) {
      container.innerHTML = `
        <div class="empty-state">
          <div class="empty-icon" style="color:var(--text-muted); opacity:0.5;">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="9" x2="15" y2="15"/><line x1="15" y1="9" x2="9" y2="15"/></svg>
          </div>
          <p>此分類暫無單字</p>
        </div>
      `;
      ...
      return `
        <div class="wl-item" style="animation-delay:${Math.min(i * 0.03, 0.3)}s">
          <div>
            ...
            <div class="wl-meaning">${w.meanings.join('；')}</div>
          </div>
